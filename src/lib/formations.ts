...
export const FORMATIONS: Formation[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { id: "lcm", position: "CM", x: 38, y: 46 },
      { id: "rcm", position: "CM", x: 62, y: 46 },
  ...
  },
  {
    ...
    slots: [
      ...
      { id: "rb", position: "RB", x: 88, y: 26 },
      { id: "cdm", position: "CDM", x: 50, y: 40 },
      { id: "lm", position: "LM", x: 14, y: 58 },
      { id: "rm", position: "RM", x: 86, y: 58 },
      { id: "cam", position: "CAM", x: 50, y: 66 },
      { id: "lst", position: "ST", x: 36, y: 88 },
      { id: "rst", position: "ST", x: 64, y: 88 },
    ],
  },
  {
    ...
    slots: [
      ...
      { id: "rb", position: "RB", x: 88, y: 26 },
      { id: "cdm", position: "CDM", x: 50, y: 40 },
      { id: "lcm", position: "CM", x: 24, y: 56 },
      { id: "ccm", position: "CM", x: 50, y: 54 },
      { id: "rcm", position: "CM", x: 76, y: 56 },
      { id: "lst", position: "ST", x: 36, y: 88 },
      { id: "rst", position: "ST", x: 64, y: 88 },
    ],
  },
  {
    ...
    slots: [
      ...
      { id: "ldm", position: "CDM", x: 36, y: 44 },
      { id: "rdm", position: "CDM", x: 64, y: 44 },
      { id: "lw", position: "LW", x: 14, y: 76 },
      { id: "cam", position: "CAM", x: 50, y: 66 },
      { id: "rw", position: "RW", x: 86, y: 76 },
      { id: "st", position: "ST", x: 50, y: 88 },
    ],
  },
  {
    ...
    slots: [
      ...
      { id: "rcb", position: "CB", x: 64, y: 20 },
      { id: "rb", position: "RB", x: 88, y: 26 },
      { id: "lcm", position: "CM", x: 36, y: 50 },
      { id: "rcm", position: "CM", x: 64, y: 50 },
  ...
  },
  {
    ...
    slots: [
      ...
      { id: "rcb", position: "CB", x: 64, y: 20 },
      { id: "rb", position: "RB", x: 88, y: 26 },
      { id: "ldm", position: "CDM", x: 38, y: 42 },
      { id: "rdm", position: "CDM", x: 62, y: 42 },
  ...
  },
  {
    ...
    slots: [
      ...
      { id: "rb", position: "RB", x: 88, y: 26 },
      { id: "cdm", position: "CDM", x: 50, y: 40 },
      { id: "lcm", position: "CM", x: 30, y: 54 },
      { id: "cam", position: "CAM", x: 62, y: 62 },
      { id: "lw", position: "LW", x: 14, y: 80 },
      { id: "st", position: "ST", x: 50, y: 88 },
      { id: "rw", position: "RW", x: 86, y: 80 },
    ],
  ...
  },
  {
    ...
    slots: [
      ...
      { id: "rcb", position: "CB", x: 64, y: 20 },
      { id: "rb", position: "RB", x: 88, y: 26 },
      { id: "lm", position: "LM", x: 12, y: 58 },
      { id: "cdm", position: "CDM", x: 50, y: 42 },
      { id: "lcm", position: "CM", x: 34, y: 56 },
      { id: "rcm", position: "CM", x: 66, y: 56 },
      { id: "rm", position: "RM", x: 88, y: 58 },
      { id: "st", position: "ST", x: 50, y: 88 },
    ],
  },
  {
  ...
  },
  {
    ...
    slots: [
      ...
      { id: "rcb", position: "CB", x: 70, y: 20 },
      { id: "rwb", position: "RWB", x: 92, y: 32 },
      { id: "lm", position: "LM", x: 14, y: 54 },
      { id: "lcm", position: "CM", x: 38, y: 50 },
      { id: "rcm", position: "CM", x: 62, y: 50 },
      { id: "rm", position: "RM", x: 86, y: 54 },
      { id: "st", position: "ST", x: 50, y: 88 },
    ],
  },
];
...
export const ATTACK_SETTINGS: readonly TacticSetting[] = [
  {
    ...
    key: "buildUp",
    label: "Build-up play",
    options: ["Balanced", "Short Passing", "Long Ball", "Counter Attack"],
    defaultIndex: 0,
  },
  {
    kind: "select",
    ...
    options: ["Balanced", "Direct Passing", "Possession", "Wing Play"],
    defaultIndex: 0,
  },
  {
    kind: "slider",
...
export const DEFENCE_SETTINGS: readonly TacticSetting[] = [
  {
    ...
    options: ["Balanced", "Deep", "Aggressive Press", "High Press"],
    defaultIndex: 0,
  },
  {
    kind: "slider",
...
export const TACTIC_SETTING_GROUPS = [
  { key: "attack", label: "Attack", settings: ATTACK_SETTINGS },
  { key: "defence", label: "Defence", settings: DEFENCE_SETTINGS },
] as const;
